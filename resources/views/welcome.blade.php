...
<head>
    ...
    <title>Stella K. Kimanzi portfolio</title>
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Stella K. Kimanzi</h1>
                <h6 class="header-mono">Frond end Designer | Full Stack Developer</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="#" class="nav-link">0715536395</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav brand">
                    <img src="/assets/imgs/profile2.jpeg" alt="" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">Stella K. Kimanzi</h5>
                        <div class="brand-subtitle">Frond end Designer | Full Stack Developer</div>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="#portfolio" class="nav-link"></a>
                    </li>
                    <li class="nav-item">
                        <a href="#blog" class="nav-link">light_kenya</a>
                    </li>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">Web Designer and a Developer</h5>
                <p class="mt-20"> Do you want to know me more?</p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 19-March-1999</li>
                    <li><span>Email</span> : stellakyeni55@gmail.com</li>
                    <li><span>Phone</span> : + (254) 715536395</li>
                    <li><span>Instagram</span> : lights_ke </li>
                    <li><span>Address</span> : Nairobi Kenya</li>
                </ul>
                <ul class="social-icons pt-3">
                    <li class="social-item"><a class="social-link" href="https://www.fb.com/l/6lp1kJRRR"><i
                    ...
                    <li class="social-item"><a class="social-link"
                            href="https://www.instagram.com/lights_kenya?igsh=MmVlMjlkMTBhMg=="><i
                                class="ti-instagram" aria-hidden="true"></i></a></li>
                    <li class="social-item"><a class="social-link" href="https://github.com/stellakyeni"><i
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>UX Design</h6>
                        <p class="subtitle"> Applying design principles to create visually appealing interfaces,
                            including color theory, typography, and layout.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Web Development- Laravel Framework</h6>
                        <p class="subtitle"> Front-End Frameworks:

                            -Familiarity with front-end frameworks such as React, Angular, or Vue.js for building
                            efficient and scalable web applications.<br>
                            Back-End Development:
                            - Knowledge of server-side programming languages like Node.js, Python (Django/Flask), Ruby
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">Search Engine Optimization (SEO):

                            - Understanding and implementing SEO best practices to improve website visibility in search
                            engine results.
                            <br>
                            Analytics and Data Analysis:
                            -Using tools like Google Analytics to analyze website and campaign performance, and making
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <P class="subtitle">- Engineered and implemented a comprehensive caseload reports system
                                for the Supreme Court using the Laravel framework.
                                <br>
                                - Collaborated closely with stakeholders, including Supreme Court officials, to gather
                                requirements and ensure the system aligned with the unique needs of the judiciary.
                                <br>
                                - Developed and maintained intricate Laravel-based features for case tracking, data
                                visualization, and real-time reporting.
                                <br>
                                - Ensured data security and integrity by implementing Laravel's authentication and
                                authorization features.
                                <br>
                                - Leveraged Laravel Eloquent ORM to manage complex database relationships, facilitating
                                efficient data retrieval for reporting purposes.
                                <br>
                                - Integrated RESTful APIs to enable seamless data exchange with external systems,
                                enhancing overall interoperability.

                                <br>
                                - Collaborated with front-end developers to create a user-friendly interface,
                            ...
                            <P>UX Developer</P>
                            <P class="subtitle">- Conducted user research and translated findings into actionable
                                design improvements.<br>
                                - Developed wireframes and prototypes for multiple projects, ensuring optimal user
                                experiences.<br>
                                - Collaborated with cross-functional teams to implement front-end and back-end
                                solutions.<br>
                                - Utilized A/B testing to refine designs and improve user engagement.</P>
                            <hr>
                            <h6 class="title text-danger">2020 - 2021</h6>
                            <P>Front-end Developer</P>
                            <P class="subtitle">- Designed and implemented responsive user interfaces using HTML, CSS,
                                and JavaScript.<br>
                                - Worked closely with UX designers to bring their vision to life and enhance the overall
                                user experience.<br>
                                - Collaborated with back-end developers to integrate front-end components with
                                server-side logic.
                            </P>
                            <hr>
                            <h6 class="title text-danger">2020 - 2021</h6>
                            ...
                            <P class="subtitle">
                                Developed server-side logic using Node.js and Express for scalable web
                                applications.<br>
                                - Designed and maintained databases, ensuring efficient data storage and retrieval.<br>
                                - Implemented RESTful APIs to facilitate communication between the front end and back
                                end.
                            </P>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h6 class="title text-danger">2023 - Present</h6>
                            <P>Diploma in Web Development (PHP)</P>
                            <P class="subtitle">Moringa School.</P>
                            <hr>
                            <h6 class="title text-danger">2018 - 2022</h6>
                            <P>Degree in Science Information Technology</P>
                            <P class="subtitle">Taita Taveta University </P>
                            <hr>

                            <h6 class="title text-danger">2013 - 2017</h6>
                            <P>High School Degree</P>
                            <P class="subtitle"> Chuluni Girls' school- Kitui.</P>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row">
                        ...
                        <div class="col-7 text-left py-3">
                            <h1 class="text-danger font-weight-bold font40">99</h1>
    ...
    <section class="section bg-dark py-5">
        <div class="container text-center">
            <h2 class="text-light mb-5 font-weight-normal">I Am Available to develop your Website</h2>
                ...
                <div class="blog-card">
                    ...
                    <div class="content-holder">
                        ...
                        <p class="post-details">
                            <a href="#">By: Admin</a>
                            <a href="#"><i class="ti-heart text-danger"></i> Stella</a>
                            <a href="#"><i class="ti-comment"></i> news</a>
                        </p>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ (254)715 536 395</span>
                                </h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Nairobi Kenya.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span
                                        class="text-muted">stellakyeni55@gmail.com</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p class="small mb-0 text-light">
                ...
                <script>
                    ...
                    href="http://devcrud.com" target="_blank"><span class="text-danger"
                        title="Bootstrap 4 Themes and Dashboards">lights_ke</span></a>
            </p>
        </div>
    </footer>
